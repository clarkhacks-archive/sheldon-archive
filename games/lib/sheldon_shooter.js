...
var SPRITE_SHEET_SRC = 'data:image/png;base64,';
var LEFT_KEY = 37;
var RIGHT_KEY = 39;
var SHOOT_KEY = 32;
...
function drawBottomHud() {
  ...
  fillText('Sheldon', CANVAS_WIDTH - 115, CANVAS_HEIGHT - 7.5);
  fillCenteredText('SCORE: ' + player.score, CANVAS_WIDTH/2, 20);
  fillBlinkingText(CANVAS_WIDTH - 25, CANVAS_HEIGHT - 7.5, TEXT_BLINK_FREQ);
}
...
function drawStartScreen() {
  fillCenteredText("Sheldon Shooter", CANVAS_WIDTH/2, CANVAS_HEIGHT/2.75, '#FFFFFF', 36);
...
document.write("<div class=\"panel-body\"><link href=\"http:\/\/fonts.googleapis.com\/css?family=Play:400,700\" rel=\"stylesheet\" type=\"text\/css\">");
document.write("<canvas id=\"game-canvas\" width=\"100%\" height=\"100%\"><\/canvas>");
console.log('Idea Credit: Collin Borror | Design & Code: Clark Weckmann')
